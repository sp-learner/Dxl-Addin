...
const FormatSynonyms = {
  "Packet No":["#STOCK ID", "BarCode", "Client Ref", "Client_Ref_No", "ClientRef", "CLYNT.", "COD", "Id", "KAPAN NO.", "LOT", "Lot ID", "Lot No", "Lot No.", "Lot Number", "Lot_ID", "LOT_NUMBER", "lotId", "LotNo", "Packet Id.", "Packet No", "PACKET_NO", "PACKETCODE", "PacketId", "PacketNo", "Parcel No.", "PId", "Pkt_No.", "Ref", "Ref No", "REF NO.", "Ref#", "Ref.No", "Reference", "REFERENCE_ID", "RefNo", "SR", "SR.NO", "SRD No", "STK ID", "STK REFF. NO.", "Stk#", "STK_NUM", "STN", "STOCK", "STOCK No", "Stock #", "Stock # ??", "Stock ID", "Stock Id KE", "STOCK ID.", "Stock No", "STOCK NUM", "Stock Ref", "STOCK#", "STOCK-ID", "stock_no", "stock_num", "StockId", "StockRef", "Stone", "Stone I'D", "Stone ID", "Stone No", "Stone No.", "StoneCode", "StoneId", "StoneNo", "UID NO"],
  Shape: ["Shape Name", "SHAPE#", "SHAP#", "Shp#", "Shape Desc", "Rap Shape", "rapShape", "Sh", "Sha", "SHAP", "SHAP.", "Shape", "Shape ??", "SHAPE.", "Shape_Code", "Shp", "Shp.", "Shp_Name"],
  Color: ["Colour", "Color (Long)", "Color C", "Col#", "CL.", "clours", "CLR", "Col", "Col.", "Color", "Color ??", "Color_Code", "ColorCode", "Colour", "Rap Color", "rapColor"],
  Clarity: ["Cl#", "Quality", "clar", "Cla#", "CAL", "Cal_Name", "CL", "Cl.", "Cla", "Cla.", "Clar", "Claratiy", "Clari", "Clarity", "Clarity ??", "Clarity_Code", "ClarityName", "CLERITY", "CLR", "Clr.", "Clrt", "CLRTY", "CTY", "Purity", "Qua", "Rap Clarity", "rapClarity"],
  Cut: ["Proportions", "CUTPROP", "CUT#", "Prop#", "Prop", "Ct", "CUT", "Cut Grade", "Cut Grade ??", "CUT.", "Cut_Code", "Cut_Grade", "CutGrade", "Final Cut", "Prop.", "PropCode"],
